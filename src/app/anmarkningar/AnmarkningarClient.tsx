    ...
    <div className="min-h-screen bg-stone-50 px-4 py-6 sm:px-6 sm:py-10">
      <div className="mx-auto max-w-3xl">
        ...
        <h1 className="mt-1 flex items-center gap-2 text-xl font-semibold text-stone-800">
          Anmärkningar att åtgärda
          <Hjalp text="Alla öppna och nyligen åtgärdade anmärkningar från samtliga SBA-kontroller, samlade på ett ställe. Klicka 'Markera åtgärdad' när du fixat felet — lägg gärna till en kommentar om vad som gjordes." />
        </h1>
